    ...
    def infer(
        ...
        *,
        ...
        if not checkpoint_path:
            ...
            if base:
                resolved_checkpoint = resolve_policy_checkpoint(policy_path(manifest, base))
                if resolved_checkpoint is None:
                    raise ActionError(
                        f"No checkpoint found for policy '{base}'. "
                        "Choose a checkpoint explicitly or place one under the policies root."
                    )
